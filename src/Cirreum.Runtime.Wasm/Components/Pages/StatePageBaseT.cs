...
/// <summary>
/// A base page that provides strongly-typed state management integration. Extends <see cref="StatePageBase"/>
...
/// For basic state management with built-in state types, consider using <see cref="SessionStatePage"/>, 
/// <see cref="LocalStatePage"/>, or <see cref="MemoryStatePage"/> instead.
/// </para>
/// </remarks>
