...
/// <summary>
/// An abstract base page component that provides container state management with pluggable storage backends.
/// Extends <see cref="StatePageBase"/> with automatic state integration and dynamic property creation.
/// </summary>
...
/// </list>
/// </remarks>
public abstract class ContainerStatePage<TStateService> : StatePageBase
	...
	/// </summary>
	/// <returns>The scope name, defaults to the page type name.</returns>
	/// <remarks>
	...
	/// <summary>
	/// Sets a property value in state.
	/// </summary>
	/// <typeparam name="T">The type of the property value</typeparam>
	...
	/// <summary>
	/// Removes all properties for this page from state.
	/// </summary>
	protected void ClearAll() {
		// Track all keys that have been accessed for this page
	...
	/// <example>
	/// For a page with namespace="MyApp", scope="UserProfile", and key="firstName":
